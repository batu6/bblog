...
knitr::include_graphics("~/R wd/bblog/images/Ps_mean.png")
```
...
knitr::include_graphics("~/R wd/bblog/images/Sampling.png")
...
```{r, layout="l-body-outset", fig.width=8, fig.height=7,fig.align='center'}
knitr::include_graphics("~/R wd/bblog/images/Sampling2.png")
```
